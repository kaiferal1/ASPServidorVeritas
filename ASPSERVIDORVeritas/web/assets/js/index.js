angular.module("mdlAppWeb", ['ngResource'])
    .controller("ctrlnav", function ($http, serv, $rootScope) {
        ...
        var jInicio = $("#inicio")
            ...
            , jFactura = $("#factura")
            , jLoading = $("#loading")
            , cliListado = $("a[href=#cliListado]")
            , servListado = $("a[href=#servListado]")
            , planListado = $("a[href=#planListado]")
            , factNoEnviadas = $("a[href=#factNoEnviadas]") ;
        /******************************************************************/
