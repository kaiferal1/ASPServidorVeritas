...
namespace ASPSERVIDORVeritas.Clases
{
    public class Mail
    {
        ...
        string DE = "Notificaciones.Mexico@mx.bureauverutas.com"; //nuestro usuario de smtp
        ...
        public bool enviaMail()
        {
            ...
            try
            {
                ...
                System.Net.Mail.SmtpClient smtpMail = new System.Net.Mail.SmtpClient("usbvrealay.bureauveritas.com");
                ...
                smtpMail.Host = "usbvrealay.bureauveritas.com"; //agregamos el servidor smtp
